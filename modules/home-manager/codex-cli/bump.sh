...
build_expr="let flake = builtins.getFlake \"git+file://${repo_root}\"; pkgs = flake.inputs.nixpkgs.legacyPackages.x86_64-linux; src = builtins.path { path = \"${package_dir}\"; name = \"codex-cli-src\"; }; in pkgs.callPackage src {}"
